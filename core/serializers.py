...
class ArticleSearchResultSerializer(serializers.Serializer):
    ...
    link = serializers.URLField(
        read_only=True, source="url", allow_null=True
    )  # Mapear 'url' del SQL a 'link' del modelo
    published_at = serializers.DateTimeField(
        read_only=True, source="published_date", allow_null=True
    )  # Mapear published_date
